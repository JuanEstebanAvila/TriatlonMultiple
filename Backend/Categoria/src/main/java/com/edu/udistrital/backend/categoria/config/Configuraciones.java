package com.edu.udistrital.backend.categoria.config;
...
public class Configuraciones {
    ...
    //Para cumplir con el Open/Close de la clase, la URL de la API "carrera"
    //se extrae y guarda en una variable
    @Value("${api.url.carrera}")//Proviene del archivo "application.properties" de la carpeta "resources"
    private String urlApiCarrera;

    /**
     * Configuración Bean de WebClient, para poder comunicarse con la API "Carrera"
     * @return
     */
    @Bean
